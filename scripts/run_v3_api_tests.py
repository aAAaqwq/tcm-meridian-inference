...
def extract_key_fields(response_data: dict) -> dict:
    """从API响应中提取关键字段 - 适配V3实际响应结构"""
    # V3响应是扁平结构，字段直接在根级别
    score_result = response_data.get("score_result", {})

    # 提取关键字段
    key_fields = {
        "score": score_result.get("score"),
        "problem_index": score_result.get("problem_index"),
        "problem_index_detail": score_result.get("problem_index_detail"),
        "lowest_points": response_data.get("lowest_points"),
        "side_bias_summary": response_data.get("side_bias_summary"),
        "cervical_lumbar_result": response_data.get("cervical_lumbar_result"),
        "meridian_analysis": response_data.get("meridian_analysis"),
        "focus_issues": response_data.get("focus_issues"),
        "gender": response_data.get("gender"),
        "summary": response_data.get("summary"),
        "reportSummary": response_data.get("reportSummary"),
        "storefront": response_data.get("storefront"),
